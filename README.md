...
```scala
libraryDependencies += "dev.zio" %% "zio-logging" % "0.0.0+380-5d0c0929-SNAPSHOT"
```
...
```scala
// JPL integration
libraryDependencies += "dev.zio" %% "zio-logging-jpl" % "0.0.0+380-5d0c0929-SNAPSHOT"

// SLF4j integration
libraryDependencies += "dev.zio" %% "zio-logging-slf4j" % "0.0.0+380-5d0c0929-SNAPSHOT"

// Using ZIO Logging for SLF4j loggers, usually third-party non-ZIO libraries
libraryDependencies += "dev.zio" %% "zio-logging-slf4j-bridge" % "0.0.0+380-5d0c0929-SNAPSHOT"
```
